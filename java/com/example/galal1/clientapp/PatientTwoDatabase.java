...
public class PatientTwoDatabase extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_patient_two_database);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    PatientTwoDatabase.this.runOnUiThread(new Runnable() {
                        public void run() {
                            //Do your UI operations like dialog opening or Toast here
                            if(client.isConnected()) Toast.makeText(PatientTwoDatabase.this, "Connected", Toast.LENGTH_SHORT).show();
                    ...
                    bufferedWriter2.write("Hello from android\n");
                    ...
                    try{
                        ...
                        for(;;){
                            ...
                            if(message.contains("b")){
                                ...
                                final MediaPlayer mp = MediaPlayer.create(PatientTwoDatabase.this, R.raw.alarm);
                                mp.start();
                                ...
                                Notification notification = new Notification.Builder(PatientTwoDatabase.this)
