...
/**
 * Created by Galal1 on 7/9/2018.
 */

public class PatientOneStreamingDetection extends AppCompatActivity  implements View.OnClickListener{
    public String ipadress = "192.168.1.105";
    //Intent intent;
    Socket client;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_patient_one_streaming_detection);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    PatientOneStreamingDetection.this.runOnUiThread(new Runnable() {
                        public void run() {
                            //Do your UI operations like dialog opening or Toast here
                            if(client.isConnected()) {
                                Toast.makeText(PatientOneStreamingDetection.this, "Connected", Toast.LENGTH_SHORT).show();
                            }
                            else if((client.isClosed())|| (!client.isConnected())||(!client.isBound())){
                                Toast.makeText(PatientOneStreamingDetection.this, "server is not connected", Toast.LENGTH_SHORT).show();
                    ...
                    try{
                        ...
                        for(;;){
                            ...
                            if(message.contains("b")){
                                ...
                                final MediaPlayer mp = MediaPlayer.create(PatientOneStreamingDetection.this, R.raw.alarm);
                                mp.start();
                                ...
                                Notification notification = new Notification.Builder(PatientOneStreamingDetection.this)
                                        .setContentTitle("Alarm")
                                        .setContentText("Patient 1 may have a seizure")
                            ...
                            if(message.length()!=0){
                                PatientOneStreamingDetection.this.runOnUiThread(new Runnable() {
                                    public void run() {
                                        ...
                                        //Do your UI operations like dialog opening or Toast here
                                        //dataView.setText(parts[0]+"    "+parts[1]);
                                        addEntry(parts[0],mChart1);
                                        addEntry(parts[1],mChart2);
                                        addEntry(parts[2],mChart3);
                                        addEntry(parts[3],mChart4);
                                        addEntry(parts[4],mChart5);
                                        addEntry(parts[5],mChart6);
                                        addEntry(parts[6],mChart7);
                                        addEntry(parts[7],mChart8);
