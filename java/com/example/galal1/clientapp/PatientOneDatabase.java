...
public class PatientOneDatabase extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_patient_one_database);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    PatientOneDatabase.this.runOnUiThread(new Runnable() {
                        public void run() {
                            //Do your UI operations like dialog opening or Toast here
                            if (client.isConnected()) {
                                Toast.makeText(PatientOneDatabase.this, "Connected", Toast.LENGTH_SHORT).show();
                            }
                    ...
                    bufferedWriter2.write("Database\n");
                    ...
                    try {
                        ...
                        for (; ; ) {
                            ...
                            if (message.contains("b")) {
                                ...
                                final MediaPlayer mp = MediaPlayer.create(PatientOneDatabase.this, R.raw.alarm);
                                mp.start();
                                ...
                                Notification notification = new Notification.Builder(PatientOneDatabase.this)
